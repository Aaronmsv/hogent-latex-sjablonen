...
% Hoofding wisselend tussen hoofdstuk en titel
% afhankelijk van even of oneven pagina
\pagestyle{fancy}
\fancyhf{}
\fancyfoot[C]{\thepage}
\fancyhead[LO]{\leftmark}
\fancyhead[RE]{\checkedrightmark}

% Neem het hoofdstuk indien geen titels
\makeatletter
\newcommand{\checkedrightmark}{%
